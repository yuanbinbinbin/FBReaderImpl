...
public final class ZLAndroidPaintContext extends ZLPaintContext {
	...
	@Override
	public void drawRoundRectangle(RectF rect, float rx, float ry) {
		myCanvas.drawRoundRect(rect, rx, ry, myOutlinePaint);
	}

	@Override
	public void fillRoundRectangle(RectF rect, float rx, float ry) {
		myCanvas.drawRoundRect(rect, rx, ry, myFillPaint);
	}
	...
	public void setLineWidth(int width) {
		...
		myOutlinePaint.setStrokeWidth(width);
	}
