...
//		final int h = getMainAreaHeight();
		...
		try {
			...
			if (TurnPageJudgeUtil.getInstance().checkIsTurnPage(view.getStartCursor())) {
				TurnPageJudgeUtil.getInstance().onTurnPage(view.getCurrentPageTextString(), view.getStartCursor(), view.getEndCursor());
			}
		} catch (Throwable t) {
