...
public final class CurlAnimationProvider extends AnimationProvider {
	...
	public CurlAnimationProvider(BitmapManager bitmapManager) {
		...
		myEdgePaint.setShadowLayer(100, 0, 0, 0xC0000000);
	}
...
//        myEdgePaint.setShadowLayer(50, 0, 0, Color.argb(192, backgroundColor.Red, backgroundColor.Green, backgroundColor.Blue));
		myEdgePath.rewind();
