...
abstract public class ZLPaintContext {
	...
	public void setTextSize(int size) {
		setFont(myFontEntries, size, myFontIsBold, myFontIsItalic, myFontIsUnderlined, myFontIsStrikedThrough);
	}
	public int getTextSize(){ return  myFontSize; }
	...
	abstract public void drawRoundRectangle(RectF rect, float rx, float ry);
	abstract public void fillRoundRectangle(RectF rect, float rx, float ry);
