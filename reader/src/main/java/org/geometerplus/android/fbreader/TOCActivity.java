...
public class TOCActivity extends ListActivity {
    ...
    private final class TOCAdapter extends ZLTreeAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            TextView title = ViewUtil.findTextView(view, R.id.toc_tree_item_text);
            title.setText(tree.getText());
            setIcon(ViewUtil.findImageView(view, R.id.toc_tree_item_icon), tree);
            title.setTextColor(tree == mySelectedItem ? Color.parseColor("#3399ff") : Color.parseColor("#333333"));
            return view;
        }
