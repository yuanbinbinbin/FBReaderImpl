...
public class ViewOptions {
    ...
    public final ZLBooleanOption HeaderShowCatalogName;
	...
	public ViewOptions() {
		...
		TopMargin =
			new ZLIntegerRangeOption("Options", "TopMargin", 0, 100, FBReaderPercentUtils.dp2px(40));
		BottomMargin =
		...
		ScrollbarType =
			new ZLIntegerRangeOption("Options", "ScrollbarType", 0, 5, FBView.SCROLLBAR_SHOW_AS_FOOTER_KAO_LA_STYLE);
		FooterHeight =
				new ZLIntegerRangeOption("Options", "FooterHeight", 8, FBReaderPercentUtils.dp2px(25), FBReaderPercentUtils.dp2px(25));
		HeaderShowCatalogName =
                new ZLBooleanOption("Options","HeaderShowCatalogName",true);
		ColorProfileName =
