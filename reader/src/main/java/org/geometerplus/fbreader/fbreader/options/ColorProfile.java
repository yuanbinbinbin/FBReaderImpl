...
public class ColorProfile {
    ...
    public final ZLColorOption MenuBackgroundOption;
    public final ZLColorOption MenuTextOption;
    public final ZLColorOption MenuSelectedTextOption;
    public final ZLColorOption BlackTextOption;
    public final ZLColorOption GrayTextOption;
    public final ZLColorOption ThinLineOption;
    ...
    private ColorProfile(String name, ColorProfile base) {
        ...
        MenuBackgroundOption.setValue(base.MenuBackgroundOption.getValue());
        MenuTextOption.setValue(base.MenuTextOption.getValue());
        MenuSelectedTextOption.setValue(base.MenuSelectedTextOption.getValue());
        BlackTextOption.setValue(base.BlackTextOption.getValue());
        ThinLineOption.setValue(base.ThinLineOption.getValue());
        GrayTextOption.setValue(base.GrayTextOption.getValue());
    }
    ...
    private ColorProfile(String name) {
        ...
        if (NIGHT.equals(name)) {
            ...
            BackgroundOption =
                    createOption(name, "Background", 34, 34, 36);
            ...
            MenuBackgroundOption =
                    createOption(name, "MenuBackgroundOption", 255, 255, 255);
            MenuTextOption =
                    createOption(name, "MenuTextOption", 153, 153, 153);
            MenuSelectedTextOption =
                    createOption(name, "MenuSelectedTextOption", 32, 163, 255);
            BlackTextOption =
                    createOption(name, "BlackTextOption", 51, 51, 51);
            ThinLineOption =
                    createOption(name, "ThinLineOption", 238, 238, 238);
            GrayTextOption =
                    createOption(name, "GrayTextOption", 191, 191, 191);
            ...
            MenuBackgroundOption =
                    createOption(name, "MenuBackgroundOption", 255, 255, 255);
            MenuTextOption =
                    createOption(name, "MenuTextOption", 153, 153, 153);//#999999
            MenuSelectedTextOption =
                    createOption(name, "MenuSelectedTextOption", 32, 163, 255);//20a3ff
            BlackTextOption =
                    createOption(name, "BlackTextOption", 51, 51, 51);//#333333
            ThinLineOption =
                    createOption(name, "ThinLineOption", 238, 238, 238);//#eeeeee
            GrayTextOption =
                    createOption(name, "GrayTextOption", 191, 191, 191);//#cccccc
        }
    }
}
